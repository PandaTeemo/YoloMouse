...
namespace Yolomouse
{
    ...
    static const Char*  NOTIFY_REQUIRE_RESTRICTED_MODE =    "Cursor binding failed. Try running Yolomouse as Administrator.";
    static const Char*  NOTIFY_ENTERED_RESTRICTED_MODE =    "Cursor binding failed. Using overlay cursors instead.";
